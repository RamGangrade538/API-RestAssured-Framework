...
//    }
    ...
    // use data faker
    public Map<String, Object> createPayloadHashMap() {
        Map<String, Object> map = new HashMap<>();
        Faker faker = new Faker();
        map.put("id", faker.number().digits(10)); // Check if this is required or auto-generated by API
        map.put("name", faker.name().fullName());
        map.put("country",faker.address().country());
        map.put("logo", RandomStringUtils.randomAlphabetic(25));
        map.put("slogan", RandomStringUtils.randomAlphabetic(20));
        map.put("head_quarters", faker.address().cityName());
        map.put("website", "https://"+RandomStringUtils.randomAlphabetic(10)+".com");
        map.put("established", faker.number().numberBetween(1990,2022));  // Make sure the format is correct
        return map;
    }
}
